...
class MnistAgent(BaseAgent):
    ...
    def __init__(self, config, config_dict, gpu_ids):
        wandb.init(project="Pytorch-Project-Template", entity="jonggyujang0123", config=config_dict, name=f'{config.agent}-lr-{config.learning_rate}', group=f'{config.agent}')
